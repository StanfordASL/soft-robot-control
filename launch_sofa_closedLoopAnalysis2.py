...
# SETTINGS
METHOD = "tpwl" # "tpwl" # "koopman" # "ssm"
SAVE_DIR = "/home/jalora/Desktop/CL_trunk_obstacle_analysis"
NUM_SIMS = 100
...
def generate_task_params():
    ...
    taskParams = {}
    # TODO: Process all data for SSMR. Pre-process data inside gusto or solver call
...
def doSimulations(method=METHOD):
    ...
    for j in tqdm(range(0, len(taskParams['X_list']))):
        ...
        p_gusto = Process(target=run_solver, args=(taskParams,))
        p_gusto.start()
        # start SOFA simulation
        root = Sofa.Core.Node()
        rootNode = createScene_CL(root, T=11.)
...
if __name__ == '__main__':
    ...
    # for method in ["koopman"]:
    #     doSimulations(method=METHOD)
    plotResults()