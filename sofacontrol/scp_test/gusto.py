...
from sofacontrol.scp_test.locp import LOCP
...
class GuSTO:
    ...
    def __init__(self, model, N, dt, Qz, R, x0, u_init, x_init, z=None, u=None,
        ...
        #TODO: Looks like 'nonlinear_observer' should get propogated through the GuSto Class call.
    ...
    def solve(self, x0, u_init, x_init, z=None, zf=None, u=None):
        ...
        # TODO: get observer linearizations here. Make sure nonlinear_observer param in model
        ...
        while self.is_valid_iteration(itr) and not converged and omega <= self.omega_max:
            ...
            # TODO: Need to modify locp.update to ensure linearization points for observer with minimal changes to TPWL
            if new_solution:
            ...
            #TODO: Figure out what is going on here. Hard-coded for now
            if tr_satisfied:
                #rho_k = 0.01
                rho_k = self.compute_accuracy(x_next, u_next, Jstar)

                # TODO: Hacking it to nudge gusto out of first iteration
